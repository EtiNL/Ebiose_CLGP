...
class CLGP(nn.Module):
    ...
    def forward(self, graphs, texts):
        ...
        if self.custom_node_feature_encoder:
            ...
            embedded_node_features = (self.node_feature_encoder(node_features.long(), attention_mask=(node_features!=0).int()).last_hidden_state)[:, 0, :]
        ...
        if self.custom_text_encoder:
            ...
            text_features = (self.text_encoder(texts, attention_mask=(texts!=0).int()).last_hidden_state)[:, 0, :]
